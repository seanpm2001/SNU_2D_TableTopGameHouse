...
function developAndroid3HoneyComb {
	
}
function android3HoneyCombPlatformDecision {
	
}
function releaseAndroid3HoneyComb {
	
}
function androidQNamingDecision {
	console.log("Some Google employees don't want to call Android 10.0 Android Q and are thinking of calling it Android 10. Do you want to continue with the dessert branding? (y/n)");
	var androidQNamingDecision = "n";
	if androidQNamingDecision == "y" {
		alert("You have made a decision that alters the original history of Google. The game will operate differently as you went against canon");
		console.log("You have decided to call Android 10 Queen Cake, as that was the last minute name. People are happy that the trend is still going.");
	} else {
		console.log("You have renamed Android Q to Android 10, ending the dessert naming theme. This upset a lot of users, but it was quickly ignored. Android 10 is now called Android 10, instead of Android 10.0 Queen Cake");
}}
