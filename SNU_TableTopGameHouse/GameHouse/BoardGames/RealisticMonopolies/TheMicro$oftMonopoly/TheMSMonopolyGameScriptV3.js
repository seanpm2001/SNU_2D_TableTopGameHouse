...
function team1 { // The CEO and founders team
	var team1_member1 == founder1; // Bill Gates (Replaces with Steve Ballmer, which in turn gets replaced by Satya Nadella)
...
// Staff
function billGatesStepDown2000 {
	console.log("It is the year 2000 and Bill Gates is thinking of retirement from Microsoft. Do you want Bill Gates to retire? (y/n)");
	var billGatesRetire2000Decision = "y";
	if billGatesRetire2000Decision == "y" {
		console.log("Bill Gates has stepped down from chairman at Microsoft on January 13th 2000, Steve Ballmer has taken over his position");
	} else {
		console.log("Microsoft has decided to keep Bill Gates at Microsoft.");
		// This is uncanonical, this will change the story if you choose yes
		alert("You have made a change that goes against the games Canon. Gameplay will no longer follow the official Microsoft history");
}}
function steveBallmerStepDown2014 {
	console.log("It is the year 2014 and Steve Ballmer is considering stepping down from Microsoft. Do you want Steve Ballmer to step down? (y/n)");
	var steveBallmerStepdown2014Decision = "y";
	if steveBallmerStepdown2014Decision = "y" {
		console.log("Steve Ballmer has stepped down from Microsoft on February 4th 2014. Satya Nadella has taken his place as CEO");
	} else {
		console.log("Microsoft has decided to keep Steve Ballmaer as a Microsoft CEO.");
		// This is uncanonical, this will change the story if you choose yes
		alert("You have made a change that goes against the games Canon. Gameplay will no longer follow the official Microsoft history");
}}
